...
#----------------------------------------------------------------------
#
# Name: make_xml_mcc3.0.sh
#
# Purpose: Make xml files for mcc 3.0.  This script loops over all
...
# Usage:
#
# make_xml_mcc3.0.sh [-h|--help] [-r <release>] [-u|--user <user>] [--local <dir|tar>] [--nev <n>] [--nevjob <n>] [--nevgjob <n>]
#
# Options:
#
# -h|--help     - Print help.
...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    -h|--help )
      echo "Usage: make_xml_mcc3.0.sh [-h|--help] [-r <release>] [-u|--user <user>] [--local <dir|tar>] [--nev <n>] [--nevjob <n>] [--nevgjob <n>]"
      exit
    ;;
